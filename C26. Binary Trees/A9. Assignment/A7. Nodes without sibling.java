...
The input tree when represented in a two-dimensional plane, it would look like this:  *image*

In respect to the root, node data in the left subtree that satisfy the condition of not having a sibling
would be 6 and 8, taken in a top-down sequence. Similarly, for the right subtree, 7 and 9 are the node data without any sibling.
