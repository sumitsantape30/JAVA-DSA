...
Start value is 120, end value is 200 and step size is 40. Therefore,
the values we need to convert are 120, 120 + 40 = 160, and 160 + 40 = 200. 
...
public class primeNumbers {
	...
	public static void FtoCel(int si, int e, int w) {

		int cel = 1;
		while (si <= e) {
			cel = 5 * (cel - 32) / 9;

			System.out.println(si + " " + cel);
			si = si + w;
		}
	}
