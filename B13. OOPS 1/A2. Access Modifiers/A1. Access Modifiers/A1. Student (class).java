...
public class Student {
	...
	String name;
	 ...
	 // humara roll no private hai so usko class ke bahar koi access nhi kr skta neigther change kr skta to private krke fayda kya,
	 // hum isme kuch functionalities add karenge
